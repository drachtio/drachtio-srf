declare module 'drachtio-srf' {
  ...
  export interface SrfRequest extends SipMessage {
    ...
    isNewInvite(): boolean
    cancel(callback: () => {})
    on(event: "response", callback: (res: SrfResponse) => void): void;
    on(event: "cancel", callback: (req: SrfRequest) => void): void;
    branch: string;
    callId: string;
    from: string;
  ...
  export interface Dialog {
    ...
    modify(sdp, { noAck: boolean }): Promise<{ sdp: string; ack: Function }>;
    ack(string): void;
  ...
  class Srf extends EventEmitter {
    ...
    options(callback: (req: SrfRequest, res: SrfResponse) => void): void;
    subscribe(callback: (req: SrfRequest, res: SrfResponse) => void): void;
    request(uri: string, opts, method, [body], callback?: (err, requestSent: SrfRequest) => void);
    request(opts, callback?: (err, requestSent: SrfRequest) => void);
